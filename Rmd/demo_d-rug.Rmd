...
output:
  ...
  html_document:
    ...
    theme: spacelab
    toc: yes
bibliography: '../data/sample_bib.bib'
---

```{r setup, include=FALSE}
knitr::opts_chunk$set(echo = TRUE)

## This line is amazing and I will tell you why...it helps when knitting externally so you can still interactively run code with root paths...however only seems to work when knitting to PDF, doesn't work within RNotebook framework
